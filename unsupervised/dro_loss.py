""" This is directly copied from https://github.com/kohpangwei/group_DRO and adapted"""
...
class LossComputer:
    def __init__(self, criterion, is_robust, dataset, alpha=None, gamma=0.1, adj=None,
    ...
    def loss(self, yhat, y, weight, group_idx=None, is_training=False):
